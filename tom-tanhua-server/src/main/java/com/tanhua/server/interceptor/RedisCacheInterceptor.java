...
public class RedisCacheInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (!equalsAnyIgnoreCase(method, "GET", "POST")) {
            // 非GET、POST的请求不进行缓存处理
            return true;
        }
    ...
    private boolean equalsAnyIgnoreCase(String method, String get, String post) {
        boolean boolGet = StringUtils.equalsIgnoreCase(method, get);
        boolean boolPost = StringUtils.equalsIgnoreCase(method, post);

        return boolGet||boolPost;
    }
